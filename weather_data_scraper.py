# -*- coding: utf-8 -*-
"""
Created on Sun May 31 15:22:52 2020
...
for vYear in range(2019, 2021):
    for vMonth in range(1, 13):
        for vDay in range(1, 32):
            ...
            theurl = "https://www.wunderground.com/history/daily/SCEL/date/" + theDate
            req = urllib.request.Request(theurl, headers={'User-Agent': 'Mozilla/6.0'})

            # extract the source data for analysis
            thepage = urllib.request.urlopen(req)
            soup = BeautifulSoup(thepage, "html.parser")
            Time = Temperature = Humidty = WindSpeed = Precipitation = "N/A"
